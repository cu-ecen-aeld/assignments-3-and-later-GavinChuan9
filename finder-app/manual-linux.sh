...
# move to rootfs, because there is where bin/busybox resides
# ref. https://www.coursera.org/learn/linux-system-programming-introduction-to-buildroot/discussions/weeks/2/threads/LSGU8uSrEe6Lkgr_6V3mOw
cd ${OUTDIR}/rootfs 
${CROSS_COMPILE}readelf -a bin/busybox | grep "program interpreter"
${CROSS_COMPILE}readelf -a bin/busybox | grep "Shared library"

# TODO: Add library dependencies to rootfs
SYSROOT=$(${CROSS_COMPILE}gcc -print-sysroot) # libc
...
sed -i "35s/.*/assignment=${assignment}/" "${OUTDIR}/rootfs/home/finder-test.sh"
